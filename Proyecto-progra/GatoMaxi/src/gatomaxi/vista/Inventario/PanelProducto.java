...
public void llenarCamposConDatos(Object[] datos) {
    txtCodBarras.setText((String) datos[2]);
    txtNombre.setText((String) datos[3]);
    txtDescripcion.setText((String) datos[4]);
    txtPrecioCompra.setText(datos[5].toString());
    txtPrecioVenta.setText(datos[6].toString());
    txtDescuento.setText(datos[7].toString());
    txtStoclkMinimo.setText(datos[8].toString());
    txtStockMaximo.setText(datos[9].toString());
    txtStockActual.setText(datos[10].toString());
    fechaVencimiento.setValue(datos[11]);
    fechaIngreso.setValue(datos[12]);
    txtMarca.setText((String) datos[13]);
    txtIndustria.setText((String) datos[14]);
    txtArea.setText((String) datos[15]);
    txtEstanteria.setText((String) datos[16]);
    txtAlmacen.setText((String) datos[17]);

    // Asumiendo que la subcategoría está en la posición 18
    String subcategoria = (String) datos[19];
    String categoria = subCategoriaAux.obtenerCategoriaDeSubcategoria(subcategoria);
    
    cmbCategoria.setSelectedItem(categoria);
    actualizarSubcategorias();
    cmbSubcategoria.setSelectedItem(subcategoria);
}
