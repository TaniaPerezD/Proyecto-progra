...
public class VentaRegistroProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gatomaxi/icon/compra_icon.png"))); // NOI18N
    ...
    private void BUSCARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BUSCARActionPerformed
        ...
        try{
            ...
            System.out.println("esta bieen caltidad");
            flag=true;
            
        }catch(NumberFormatException e){
            System.out.println("esta mal caltidad");
            Notifications.getInstance().show(Notifications.Type.ERROR,"Cantidad sola acepta valores numericos");
        }
        if(flag==true){
            buscar(CODIGO.getText());
            if(encontrado==true){
                AGREGAR.setEnabled(true);
                Notifications.getInstance().show(Notifications.Type.SUCCESS,"Se ha encontrado el producto");
            }
        }
    ...
    private void AGREGARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AGREGARActionPerformed
        ...
        if(llenado==false){
            ...
            if(jTable1.getValueAt(0, 1)==null){
                insertFactura();
                System.out.println("Se ha ingresado la factura");
                index=0;
            }
            Double subtotal=((cantidad*precioUnitario)-((descuento*0.01)*(cantidad*precioUnitario)));
            ...
            jTable1.setValueAt((subtotal), index, 4);
            index++;
    ...
    private void PAGARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PAGARActionPerformed
        ...
        if(!(CANCELADO.getText().isEmpty() )){
            try {
                ...
                if(cancelado<total){
                    Notifications.getInstance().show(Notifications.Type.ERROR,"Ingrese el valor valido para pagar");
                }
                else{
                    TOTAL.setText(""+total);
                ...
                Notifications.getInstance().show(Notifications.Type.ERROR,"Ingrese un valor numerico para pagar");
            }
        }
        else{
            Notifications.getInstance().show(Notifications.Type.ERROR,"Ingrese el valor con el que va a pagar");
        }
    ...
    private void NUEVOCLIENTEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NUEVOCLIENTEActionPerformed
        VentaRegistroCliente pantalla = new VentaRegistroCliente(idCliente);
    ...
    public void buscar(String codigo_barra) {
        ...
        try{
            flag=true;
            cantidad = Integer.parseInt(CANTIDAD.getText());
            System.out.println("esta perfecta");
            ...
            if (connection != null) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        int totalStock = stockActua - cantidad;
                        STOCK.setText(String.valueOf(totalStock));
                        
                        

                    } else {
                        Notifications.getInstance().show(Notifications.Type.ERROR,"No se encontró ningún producto con el código de barras especificado o no cumple con las condiciones");
    ...
    public void actualizarStock() {
        String query = "UPDATE PRODUCTO SET stock_actual = ?, estado = ? WHERE codigo_barra = '"+codigo+"' ;";
    ...
    */
    public void generarFactura(){
        ...
        try{
            ...
            infoEmpresa+="\n";
            infoEmpresa+="DATOS CLIENTE\n";
            infoEmpresa+="ID CLIENTE: "+idCliente+"\n";
            infoEmpresa+="RAZON SOCIAL: "+cl.getRazonSocial()+"\n";
            infoEmpresa+="NIT: "+cl.getNit()+"\n";
            infoEmpresa+="TELEFONO: "+cl.getTelefono()+"\n";
            infoEmpresa+="\n";
            infoEmpresa+="TOTAL COMPRA: "+total+"\n";
            infoEmpresa+="Gracias por su preferencia\n";
    ...
    public Cliente buscarCliente() {
        ...
        String razonSocial="";
        String email="";
        String query = "SELECT nit,telefono,razon_social,email FROM cliente WHERE id_cliente = ? ";
        ConeBD conn = new ConeBD();
        Connection connection = conn.conectar();
        if (connection != null) {
            PreparedStatement pst = null;
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    System.out.println("Srazon: " + razonSocial);
        ...
        Cliente cl = new Cliente(idCliente,nit,telefono,email,razonSocial,"Activo");
        return cl;
    }
