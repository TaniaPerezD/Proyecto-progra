...
public class Empleado implements Abm{
    ...
    ////
    public static int verificarId(String usuario, String contrasenia) {
        int idEmpleaod = 0;
        String sql = "SELECT id_empleado FROM empleado WHERE usuario = ? AND contrasenia = ?";
        ...
        if(connection != null){
            try {
                ...
                if (rs.next()) {
                    idEmpleaod = rs.getInt("id_empleado");
                }
    ...
    ///
    public static String[] verificarRolEstado(String usuario, String contrasenia) {
    String[] resultado = new String[2];
    String sql = "SELECT rol, estado FROM empleado WHERE usuario = ? AND contrasenia = ?";
    ...
    if (connection != null) {
        try {
            ...
            if (rs.next()) {
                resultado[0] = rs.getString("rol");  // rol
                resultado[1] = rs.getString("estado");  // estado
            }
